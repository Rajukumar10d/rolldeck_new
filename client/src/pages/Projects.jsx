...
const projects = [
  ...
  },
  {
    index: 4,
    tag: "Website",
    title: "Pinplug electronics",
    image: stride, // Now defined
    description: "Web design for an influencer marketing agency with a bold, graphic look.",
    category: "Web",
    stats: "Speed +2.4s",
  },
  {
    ...
    tag: "Brand & Web",
    title: "Side+",
    image: sideplus, // Now defined
    description: "Streaming platform for exclusive creator content.",
    category: "Brand",
    stats: "Subscriptions +18%",
  },
];
