...
const founders = [
  { name: "CEO Name", role: "Chief Executive Officer", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1000", bio: "Leading the creative vision and high-level studio strategy." },
  { name: "CTO Name", role: "Chief Technology Officer", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=1000", bio: "Masterminding the technical architecture and data logic." },
  { name: "CMO Name", role: "Chief Marketing Officer", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=1000", bio: "Driving brand growth and market-facing communication." }
];
            ...
            {founders.map((founder, i) => (
              <div key={i} className="founder-card bg-white/2 p-4 rounded-lg overflow-hidden">
                <div className="founder-image-wrapper overflow-hidden rounded-md mb-4 will-change-transform">
                  <img src={founder.image} alt={founder.name} className="founder-img w-full h-48 object-cover" />
                </div>
      ...
      <section className="about-services py-20">
        <div className="max-w-6xl mx-auto px-5">
          <div className="services-grid grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="services-list lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {services.map((s, i) => (
                <div key={i} className="service-item p-4 bg-white/3 rounded-md">
                  <div className="service-top mb-2">
                    <span className="service-num text-sm text-white/50">/ {String(i + 1).padStart(2, '0')}</span>
                    <h3 className="service-title mt-2 text-lg font-semibold">{s.title}</h3>
                  </div>
                  <p className="service-description text-white/70">{s.desc}</p>
                </div>
              ))}
            </div>
          </div>
